...
public class Principal extends JFrame implements ActionListener {
    ...
    public Principal() {
        ...
        ImageIcon imagen = new ImageIcon("src/main/java/images/logo-coca.png");
        ...
        textarea1.setText("\n   Aquí va el resultado del cálculo de las vacaciones.");
    ...
    public void actionPerformed(ActionEvent e) {
                ...
                if (Departamento.equals("Atención al Cliente")) {
                    ...
                    if (Antiguedad.equals("1 año de servicio")) {
                        textarea1.setText("\n   El trabajador " + nombreTrabajador + " " + AP + " " + AM
                                + "\n   quien pertenece al " + Departamento + " con " + Antiguedad
        ...
        if (e.getSource() == miElCreador) {
            ...
            JOptionPane.showMessageDialog(null, "Desarrollado por Manuel Sánchez\n" 
